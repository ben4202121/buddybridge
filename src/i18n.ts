...
const ZH: Record<string, string> = {
    ...
    'settings.restartHint': '💡 安装技能后需完全退出并重开 CodeBuddy/WorkBuddy（或重启 Obsidian），技能才会出现在 available_skills。',
    'marker.skill': '[系统注入·技能: {name}]',

    // P3 LLM Wiki
    'marker.llmWiki': '[系统注入·LLM Wiki]',
    ...
    'marker.attachedFile': '[系统注入·附加文件: {path}]',
    'marker.attachedCount': '[系统注入·已附加 {n} 个文件，请逐一阅读并全部纳入参考]',
...
const EN: Record<string, string> = {
    ...
    'settings.restartHint': '💡 After installing, fully quit and reopen CodeBuddy/WorkBuddy (or restart Obsidian) for the skill to appear in available_skills.',
    'marker.skill': '[System injection·Skill: {name}]',

    // P3 LLM Wiki
    'marker.llmWiki': '[System injection·LLM Wiki]',
    ...
    'marker.attachedFile': '[System injection·Attached file: {path}]',
    'marker.attachedCount': '[System injection·{n} files attached, read each one and consider all of them]',
