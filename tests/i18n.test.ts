...
const ALL_KEYS = [
    ...
    'queue.delete',
    'usage.label',
    'marker.currentNote', 'marker.noNote', 'marker.vault', 'marker.forkTranscript', 'marker.sessionReset', 'marker.skill', 'marker.attachedCount',
    'cmd.attachCurrentNote',
    'attach.title', 'attach.remove', 'attach.empty', 'attach.menu', 'attach.notice', 'attach.invalid', 'attach.noActiveNote', 'attach.dropHint', 'attach.truncated', 'attach.truncatedNotice',
    'tab.heading.skills', 'settings.skillsIntro', 'settings.skillsIntroDesc',
    'settings.installedTitle', 'settings.installedDesc', 'settings.refreshBtn', 'settings.installedEmpty',
    'settings.installedScanFail', 'settings.installedEnable', 'settings.marketTitle', 'settings.marketSearch',
    'settings.copyInstall', 'settings.copyInstallDone', 'settings.copyInstallFail', 'settings.restartHint',
